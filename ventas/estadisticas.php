...
// Cuántos hay de cada categoria
$sqlGrupo = "SELECT categoria, COUNT(*) AS cantidad
             FROM productos
             GROUP BY categoria
...
<head>
    <meta charset="UTF-8">
    <title>Estadísticas | Ventas</title>
...
<body class="container my-4">
    ...
    <h2 class="h5">Distribución por categoría</h2>
    <?php if ($total > 0) { ?>
        ...
        <div class="mb-3">
            <div class="d-flex justify-content-between">
                <strong><?= htmlspecialchars($g["categoria"]) ?></strong>
